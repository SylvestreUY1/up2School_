...
class BackendApiService {
  ...
  Future<void> deleteFaculty(String facultyId) async {
    try {
      await _dio.delete('/api/faculties/$facultyId');
    } catch (error) {
      throw Exception(_extractError(error, 'Delete faculty error'));
    }
  }
  ...
  Future<void> addLevel(String facultyId, String level) async {
    try {
      await _dio
          .post('/api/faculties/$facultyId/levels', data: {'level': level});
    } catch (error) {
      throw Exception(_extractError(error, 'Add level error'));
    }
  }
  ...
  Future<void> removeLevel(String facultyId, String level) async {
    try {
      ...
      throw Exception(_extractError(error, 'Remove level error'));
    }
  }
  ...
  Future<void> addField(String facultyId, String level, String field) async {
    try {
      ...
      throw Exception(_extractError(error, 'Add field error'));
    }
  }

  Future<void> removeField(String facultyId, String level, String field) async {
    try {
      await _dio.delete(
        '/api/faculties/$facultyId/fields',
        data: {
      ...
      throw Exception(_extractError(error, 'Remove field error'));
    }
  }
  ...
  Future<void> addUnit(
    ...
    try {
      ...
      throw Exception(_extractError(error, 'Add unit error'));
    }
  }
  ...
  Future<void> removeUnit(
    ...
    try {
      ...
      throw Exception(_extractError(error, 'Remove unit error'));
    }
  }
